...
from opendrive2discretenet.opendriveparser.parser import parse_opendrive as parse_opendrive_xml
...
def main():
    ...
    path_opendrive = 'intersection_12_61_4.xodr'
    # path_opendrive_unicode = os.path.abspath(path_opendrive.decode('utf-8'))

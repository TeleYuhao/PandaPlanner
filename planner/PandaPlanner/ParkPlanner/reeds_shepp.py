...
def calc_reeds_shepp(start_state, end_state, maxc=0.2, step_size=STEP_SIZE):
    sx,sy,syaw = start_state[0],start_state[1],start_state[2]
    gx,gy,gyaw = end_state[0],end_state[1],end_state[2]
    paths = calc_all_paths(sx, sy, syaw, gx, gy, gyaw, maxc, step_size=step_size)
